...
public class Distance {
	...
	public static double distanceNDCG(int[] uItemID, double[] relevance, int[] vItemID, double[] userScore) {
		...
		Sortor.quickSort(uItemID, relevance, 0, m - 1, true);
		Sortor.quickSort(vItemID, userScore, 0, m - 1, true);
		//now compute ndcg
		double dcg = 0.0;
		double idcg = 0.0;
		int[] id = new int[m];
		...
		Sortor.quickSort(userScore, id, 0, m - 1, false);
		...
		Sortor.quickSort(relevance, id, 0, m - 1, false);
	...
	public static double distanceKendall(int[] uItemID, double[] uScore, int[] vItemID, double[] vScore, int n) {
		Sortor.quickSort(uItemID, uScore, 0, uItemID.length - 1, true);		
		Sortor.quickSort(vItemID, vScore, 0, vItemID.length - 1, true);		
	...
	public static void computeAverageRank(double[] score, double[] prb) {
		...
		Sortor.quickSort(scoreClone,id,0,k-1,false); 
